...
// Lists available writable calendars formatted as a JSON string array of objects.
// On success, returns 0 and sets *out_json to allocated C string (free with calendar_apple_free_string).
...
// Creates an event in the specified Apple calendar (or default if calendar parameters are NULL or empty).
...
// title, location, notes, url, recurrence_rule, calendar_id, calendar_title, calendar_source_title can be NULL or UTF-8 strings.
